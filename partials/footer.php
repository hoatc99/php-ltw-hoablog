    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">HoaBlog</h2>
                    <p>Nơi kết nối cảm xúc của những trái tim băng giá</p>
            ...
            <!-- <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Bài viết mới nhất</a></li>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">Hãy theo dõi chúng tôi</h2>
                    <p>Chúng tôi sẽ thông báo cho bạn mỗi khi có bài viết mới. <br/>Thông tin của bạn hoàn toàn được bảo mật.</p>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <p>&copy; Bản quyền thuộc về Trần Cẩm Hòa cùng với hàng triệu con <i class="icon-heart" aria-hidden="true"></i></p>
            </div>
        </div>
    </div>
</footer>
